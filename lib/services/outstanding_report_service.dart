          ...
          return [
            pw.Container(
              ...
              decoration: const pw.BoxDecoration(
                color: PdfColors.white,
                border: pw.Border(
                  bottom: pw.BorderSide(width: 1.5, color: PdfColors.grey300),
                ),
              ),
              child: pw.Row(
                    ...
                    children: [
                      ...
                      image != null
                          ? pw.Container(
                              ...
                              child: pw.Image(image, width: 80, height: 60),
                            )
                          : pw.Text(
                ...
                children: [
                  ...
                  pw.Container(
                    ...
                    decoration: pw.BoxDecoration(
                      ...
                      borderRadius: pw.BorderRadius.circular(6),
                      border:
                          pw.Border.all(color: PdfColors.orange200, width: 0.5),
                    ),
                    padding: const pw.EdgeInsets.all(15),
                    child: pw.Text(
                      ...
                      pw.Expanded(
                        ...
                        child: pw.Column(
                          ...
                          children: [
                            ...
                            pw.SizedBox(height: 5),
                            pw.Text(
                              'General No.: 011-4822800\n'
                              'Extension: 310, 318, 319\n\n'
                              'Mobile Contacts:\n'
                              'Anjali - 070-3469634\n'
                              'Chandima - 071-0798637\n'
                              'Anusha - 071-0798603\n'
                              'Dilki - 070-3641350',
                              style: const pw.TextStyle(
                                fontSize: 8,
